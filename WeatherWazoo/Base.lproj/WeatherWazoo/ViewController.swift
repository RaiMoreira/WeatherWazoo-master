...
//  WeatherWazoo
//
//  Created by Ray Moreira on 6/28/17.
...
class ViewController: UIViewController, UISearchBarDelegate {
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
        ...
        let urlRequest = URLRequest(url: URL(string: "http://api.apixu.com/v1/current.json?key=c1c093e77d054d29bde41244173006&q=\(searchBar.text!.replacingOccurrences(of: " ", with: "%20"))")!)
        ...
        let task = URLSession.shared.dataTask(with: urlRequest) { (data, response, error) in
            ...
            if error == nil {
                do {
                    ...
                    //only refresh in app if city exists
